...
/***/ function(module, exports, __webpack_require__) {
	...
	jQuery(document).ready(function ($) {
		...
		if ($sliderElseUniversal.length) {
			$sliderElseUniversal.children('.slider_else_universal').carouFredSel(_defineProperty({
				play: true,
				auto: true,
				circular: true,
				responsive: true,
