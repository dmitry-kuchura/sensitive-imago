                        ...
                        /* WEBPACK VAR INJECTION */(function (module) {
                            ...
                            !function (a, b) {
                                ...
                                n.extend({hasData: function hasData(a) {
                                        ...
                                        var c = b + "queueHooks";
                                        return N.get(a, c) || N.access(a, c, {empty: n.Callbacks("once memory").add(function () {
                                ...
                                !function () {
                                    ...
                                    if (h.style) {
                                        (function () {
                                            ...
                                            n.extend(l, {pixelPosition: function pixelPosition() {
                                                    return i(), b;
                                ...
                                n.Animation = n.extend(_a, {tweeners: {"*": [function (a, b) {
                                    ...
                                    var d = a && "object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) ? n.extend({}, a) : {complete: c || !c && b || n.isFunction(a) && a, duration: a, easing: c && b || b && !n.isFunction(b) && b};
                                ...
                                n.fn.extend({attr: function attr(a, b) {
                                ...
                                var cb = /^(?:input|select|textarea|button)$/i,
                                        db = /^(?:a|area)$/i;
                                n.fn.extend({prop: function prop(a, b) {
                                ...
                                var gb = /\r/g,
                                        hb = /[\x20\t\r\n\f]+/g;
                                n.fn.extend({val: function val(a) {
                                        var b,
                                                c,
                                                d,
                                                e = this[0];
                                ...
                                n.extend(n.event, {trigger: function trigger(b, c, e, f) {
                                        var g,
                                                h,
                                                i,
                                                j,
                                        ...
                                        if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !ib.test(q + n.event.triggered) && (q.indexOf(".") > -1 && (r = q.split("."), q = r.shift(), r.sort()), l = q.indexOf(":") < 0 && "on" + q, b = b[n.expando] ? b : new n.Event(q, "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) && b), b.isTrigger = f ? 2 : 3, b.namespace = r.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : n.makeArray(c, [b]), o = n.event.special[q] || {}, f || !o.trigger || o.trigger.apply(e, c) !== !1)) {
                                ...
                                l.cors = !!Ib && "withCredentials" in Ib, l.ajax = Ib = !!Ib, n.ajaxTransport(function (b) {
                                    var _c, d;
                                    return l.cors || Ib && !b.crossDomain ? {send: function send(e, f) {
                                            var g,
                                                    h = b.xhr();
                                ...
                                var Jb = [],
                                        Kb = /(=)\?(?=&|$)|\?\?/;
                                n.ajaxSetup({jsonp: "callback", jsonpCallback: function jsonpCallback() {
                                ...
                                n.fn.load = function (a, b, c) {
                                    ...
                                    var d,
                                            ...
                                            g = this,
                                            h = a.indexOf(" ");
                                    return h > -1 && (d = n.trim(a.slice(h)), a = a.slice(0, h)), n.isFunction(b) ? (c = b, b = void 0) : b && "object" == (typeof b === "undefined" ? "undefined" : _typeof(b)) && (e = "POST"), g.length > 0 && n.ajax({url: a, type: e || "GET", dataType: "html", data: b}).done(function (a) {
                                ...
                                n.offset = {setOffset: function setOffset(a, b, c) {
                                        ...
                                        f = d && d.ownerDocument;
                                        if (f)
                                            return b = f.documentElement, n.contains(b, d) ? (e = d.getBoundingClientRect(), c = Mb(f), {top: e.top + c.pageYOffset - b.clientTop, left: e.left + c.pageXOffset - b.clientLeft}) : e;
                    ...
                    /***/ function (module, exports, __webpack_require__) {
                        ...
                        !function (a) {
                            ...
                            a.magnificPopup.registerModule(I, {options: {settings: null, cursor: "mfp-ajax-cur", tError: '<a href="%url%">The content</a> could not be loaded.'}, proto: {initAjax: function initAjax() {
                                        ...
                                        var d = a.extend({url: c.src, success: function success(d, e, f) {
                                                var g = {data: d, xhr: f};
