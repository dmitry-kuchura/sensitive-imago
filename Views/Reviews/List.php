    ...
    <?php foreach ($result as $obj): ?>
        <div class="textReview">
            ...
            <div class="textReview__footer">
                <div class="textReview__moreLink" data-text="<?php echo __('Скрыть'); ?>"><?php echo __('Читать отзыв полностью'); ?> <span class="textReview__arrow"></span></div>
...
<div class="sectionTitle sectionTitle--inner _mt-x2">Оставить отзыв
    <svg class="reviewsForm__decor">
    <use xlink:href="hidden/sprite.svg#quotes"></use>
    </svg>
</div>
<div class="reviewsForm js-form form" data-form="true">
    <div class="grid grid--space grid--items-center">
        <div class="grid__cell">
            <input class="form__input" type="text" name="name"
                   placeholder="Ваше имя*" data-rule-word="true" data-rule-minlength="2" required>
        </div>
        <div class="grid__cell">
            <input class="form__input numbers_only" type="text" name="tel"
                   placeholder="Ваш телефон" required data-rule-phone="true">
        </div>
        ...
        <div class="grid__cell grid__cell--12">
            <textarea class="form__input form__input--textarea" type="text" placeholder="Ваш комментарий*" required></textarea>
        </div>
        <div class="grid__cell grid__cell--grow"></div>
        <div class="grid__cell">
            <button class="js-form-submit button button--primary">Отправить отзыв</button>
        </div>
    </div>
</div>