...
#### Первые задачи для начала сборки проекта верстки

Для старта работы нужно запустить две задачи:

1. `gulp build` - для составления базовой, итоговой, верстки
2. `gulp docs` - для составления базовой документации
