...
use Core\Config;
use Core\Widgets;
use Modules\Equipment\Models\Results AS Model;

class Results extends \Modules\Base
{
    ...
    public function before()
    {
        ...
        $this->setBreadcrumbs(__('Примеры результатов тестирования'), 'equipment/technology');
