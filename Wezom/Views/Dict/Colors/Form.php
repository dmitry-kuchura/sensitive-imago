            ...
            <div class="widgetContent">
                <div class="form-vertical row-border">
                    <div class="form-group">
                        ...
                        <div class="">
                            <?php if (is_file( HOST . Core\HTML::media('images/colors/original/'.$obj->image) )): ?>
                                <a href="<?php echo Core\HTML::media('images/colors/original/'.$obj->image); ?>" rel="lightbox">
                                    <img src="<?php echo Core\HTML::media('images/colors/small/'.$obj->image); ?>" style="max-height: 100px;" />
                                </a>
                                <br />
                                <a href="/wezom/<?php echo Core\Route::controller(); ?>/delete_image/<?php echo $obj->id; ?>"><?php echo __('Удалить изображение'); ?></a>
                                <br />
                                <a href="<?php echo \Core\General::crop('colors', 'small', $obj->image); ?>"><?php echo __('Редактировать'); ?></a>
                            <?php else: ?>
