        ...
        <div class="widget">
            ...
            <div class="widgetContent">
                <div class="form-vertical row-border">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="f_alias"><?php echo __('Цена'); ?> $</label>
                        <div class="">
                            <input id="f_alias" class="form-control valid" name="FORM[price]" type="text" value="<?php echo $obj->price; ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="f_alias"><?php echo __('Себестоимость'); ?> $</label>
                        <div class="">
                            <input id="f_alias" class="form-control valid" name="FORM[amount]" type="text" value="<?php echo $obj->amount; ?>" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="widgetContent">
                <div class="form-vertical row-border">
                    <div class="form-group">
                        ...
                        <div class="">
                            <?php if (is_file( HOST . Core\HTML::media('images/cert/original/'.$obj->image) )): ?>
                                <a href="<?php echo Core\HTML::media('images/cert/original/'.$obj->image); ?>" rel="lightbox">
                                    <img src="<?php echo Core\HTML::media('images/cert/small/'.$obj->image); ?>" style="max-height: 100px;" />
                                </a>
                                <br />
                                <a href="/wezom/<?php echo Core\Route::controller(); ?>/delete_image/<?php echo $obj->id; ?>"><?php echo __('Удалить изображение'); ?></a>
                                <br />
                                <a href="<?php echo \Core\General::crop('cert', 'small', $obj->image); ?>"><?php echo __('Редактировать'); ?></a>
                            <?php else: ?>
