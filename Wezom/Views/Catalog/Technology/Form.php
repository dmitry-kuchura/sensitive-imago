            ...
            <div class="widgetContent">
                <div class="form-vertical row-border">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <?php if (is_file(HOST . Core\HTML::media('images/features/original/' . $obj->image))): ?>
                                <a href="<?php echo Core\HTML::media('images/features/original/' . $obj->image); ?>"
                                   rel="lightbox">
                                    <img src="<?php echo Core\HTML::media('images/features/main/' . $obj->image); ?>"
