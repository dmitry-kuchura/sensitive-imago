                    ...
                    <tbody>
                        <?php foreach($orders AS $obj): ?>
                            <tr>
                                ...
                                <td><b><?php echo \Core\Support::pricePretty($obj->amount, $obj->currency); ?></b></td>
                                ...
                                <td class="align-center hidden-xs">
                                    <span class="btn-group">
                                        <a title="<?php echo __('Перейти к заказу'); ?>" class="tip btn btn-xs bs-tooltip" href="/wezom/orders/edit/<?php echo $obj->id; ?>"><?php echo __('К заказу'); ?></a>
                                    </span>
                                </td>
                            </tr>
                        <?php endforeach; ?>
