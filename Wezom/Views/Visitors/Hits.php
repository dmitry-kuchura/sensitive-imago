        ...
        <div class="widget">
            <div class="widgetHeader" style="padding-bottom: 10px;">
                <form class="widgetContent filterForm" action="/wezom/<?php echo Core\Route::controller(); ?>/index" method="get">
                    ...
                    <div class="col-md-2">
                        <label class="control-label"><?php echo __('Ответ сервера'); ?></label>
                        <div class="">
                            <div class="controls">
                    ...
                    <div class="col-md-2">
                        <label class="control-label"><?php echo __('Устройство'); ?></label>
                        <div class="">
                            <div class="controls">
                        ...
                        <div class="">
                            <div class="controls">
                                <select name="sort" class="form-control">
                                    <option value="updated_at-desc"><?php echo __('По дате последнего обновления Я -> А'); ?></option>
                                    <option value="updated_at-asc" <?php echo \Core\Arr::get($_GET, 'sort') == 'updated_at-asc' ? 'selected' : NULL; ?>><?php echo __('По дате последнего обновления А -> Я'); ?></option>
                                    <option value="created_at-desc" <?php echo \Core\Arr::get($_GET, 'sort') == 'created_at-desc' ? 'selected' : NULL; ?>><?php echo __('По дате первого посещения Я -> А'); ?></option>
                                    <option value="created_at-asc" <?php echo \Core\Arr::get($_GET, 'sort') == 'created_at-asc' ? 'selected' : NULL; ?>><?php echo __('По дате первого посещения А -> Я'); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-striped table-hover checkbox-wrap">
                        <thead>
                            <tr>
                                <th>IP</th>
                                <th>URL</th>
                                <th><?php echo __('Ответ сервера'); ?></th>
                                <th><?php echo __('Устройство'); ?></th>
                                <th><?php echo __('Дата посещения'); ?></th>
                                <th><?php echo __('Дата последнего обновления страницы'); ?></th>
                                <th><?php echo __('Всего обновлений страницы'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
