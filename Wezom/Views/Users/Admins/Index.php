                        ...
                        <ul class="dropdownMenu pull-right">
                            ...
                            <li>
                                <a href="<?php echo Core\Support::generateLink('status', 1); ?>">
                                    <i class="fa-filter"></i><?php echo __('Опубликованы'); ?>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo Core\Support::generateLink('status', 0); ?>">
                                    <i class="fa-filter"></i><?php echo __('Неопубликованы'); ?>
                                </a>
                            </li>
                        </ul>
                                ...
                                <td class="nav-column">
                                    <ul class="table-controls">
                                        <li>
                                            ...
                                            <ul class="dropdownMenu pull-right">
                                                <li>
                                                    <a href="/wezom/admins/edit/<?php echo $obj->id; ?>" title="<?php echo __('Редактировать'); ?>"><i class="fa-pencil"></i> <?php echo __('Редактировать'); ?></a>
                                                </li>
                                                <li class="divider"></li>
                                                <li>
                                                    <a title="<?php echo __('Удалить'); ?>" onclick="return confirm('Удалить администратора без возможности вернуться?');" href="/wezom/<?php echo Core\Route::controller(); ?>/delete/<?php echo $obj->id; ?>"><i class="fa-trash-o text-danger"></i> <?php echo __('Удалить'); ?></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
