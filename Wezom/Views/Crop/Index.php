        ...
        <div class="widget box">
            <div class="widgetHeader">
                <div class="widgetTitle">
                    <i class="fa-edit"></i> <?php echo __('Редактирование изображения'); ?>
                </div>
            </div>
            <div class="widgetContent">
                <div class="col-md-5 cropBlock">
                    <div class="cropBlockIn">
                        <img src="<?php echo $image; ?>" alt="<?php echo __('Изображение'); ?>">
                    </div>
                </div>
                <div class="col-md-1">
        ...
        $('#croppedBtn').on('click', function(event) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    preloader();
                    if(data.success) {
                        generate('<?php echo __('Фото обрезано!'); ?>', 'success', 5000);
                    } else {
                        generate('<?php echo __('Что-то пошло не так!'); ?>', 'warning', 5000);
                    }
                },
                error: function(data) {
                    preloader();
