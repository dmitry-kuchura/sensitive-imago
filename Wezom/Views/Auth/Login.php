<div class="auLogin"><input type="text" id="login" class="loginFormEl formIconLogin" autocomplete="off" autofocus placeholder="<?php echo __('Логин'); ?>"></div>
<div class="auPass"><input type="password" id="password"  class="loginFormEl formIconPass" autocomplete="off" placeholder="<?php echo __('Пароль'); ?>"></div>
<div class="error"></div>
<div class="auRe">
    <label>
