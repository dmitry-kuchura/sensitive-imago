            ...
            <div class="widgetContent">
                <div class="form-vertical row-border">
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <?php if (is_file(HOST . Core\HTML::media('images/video_tree/main/' . $obj->image))): ?>
                                <a href="<?php echo Core\HTML::media('images/video_tree/original/' . $obj->image); ?>"
                                   rel="lightbox">
                                    <img style="max-height: 150px;"
                                         src="<?php echo Core\HTML::media('images/video_tree/main/' . $obj->image); ?>"/>
                                </a>
                                <br/>
                                <a class="otherLink"
                                ...
                                <br/>
                                <a href="<?php echo \Core\General::crop('video_tree', 'main', $obj->image); ?>"><?php echo __('Редактировать'); ?></a>
                            <?php else: ?>
