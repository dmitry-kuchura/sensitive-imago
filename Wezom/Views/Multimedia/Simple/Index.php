                ...
                <div class="dd3-content">
                    <table>
                        <tr>
                            ...
                            <td valign="<?php echo $obj->url ? 'top' : 'middle'; ?>" class="pagename-column" style="width: 70px;">
                                <div class="clearFix">
                                    <div class="pull-left">
                                        <div class="pull-left">
                                            <div>
                                                <?php if (is_file(HOST.Core\HTML::media('images/slider_simple/main/'.$obj->image))): ?>
                                                    <a href="/wezom/<?php echo Core\Route::controller(); ?>/edit/<?php echo $obj->id; ?>">
                                                        <img src="<?php echo Core\HTML::media('images/slider_simple/main/'.$obj->image); ?>" alt="<?php echo $obj->name; ?>" width="50">
                                                    </a>
                                                <?php else: ?>
                                                    ----
                                                <?php endif ?>
                            ...
                            <td class="hidden-xs" valign="middle" style="width: 120px;">
                                <?php if ($obj->title): ?>
                                    <a href="/wezom/<?php echo Core\Route::controller(); ?>/edit/<?php echo $obj->id; ?>">
                                        <?php echo $obj->title; ?>
                                    </a>
