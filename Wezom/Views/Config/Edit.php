                                    ...
                                    <li class="t_item">
                                        ...
                                        <div class="t_content">
                                            <?php foreach ($result[$group->alias] as $obj): ?>
                                                <?php echo \Core\View::tpl(array('obj' => $obj, 'pages' => $pages, 'control' => $control, 'c_groups' => $c_groups), 'Config/Row'); ?>
                                            <?php endforeach; ?>
                                        </div>
                                    </li>
                                <?php endif; ?>
    ...
    $(function(){
        ...
        $('.showPassword').on('click', function(){
            ...
            if(input.attr('type') == 'password') {
                ...
                $(this).text('<?php echo __('Скрыть'); ?>');
            } else {
                input.attr('type', 'password');
                $(this).text('<?php echo __('Показать'); ?>');
            }
        });
    });
</script>