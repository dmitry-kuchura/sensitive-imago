<div class="widgetHeader" style="padding-bottom: 10px;">
    <form class="widgetContent filterForm" action="/wezom/seo_redirects/index" method="get">
        <div class="col-md-2">
            <label class="control-label"><?php echo __('Ссылка с'); ?></label>
            <div class="">
                <div class="controls">
        ...
        <div class="col-md-2">
            <label class="control-label"><?php echo __('Ссылка на'); ?></label>
            <div class="">
                <div class="controls">
        ...
        <div class="col-md-2">
            <label class="control-label"><?php echo __('Тип'); ?></label>
            <div class="">
                <div class="controls">
                                ...
                                <ul class="table-controls">
                                    <li>
                                        ...
                                        <ul class="dropdownMenu pull-right">
                                            <li>
                                                <a title="<?php echo __('Редактировать'); ?>" href="<?php echo '/wezom/seo_redirects/edit/'.$obj->id; ?>"><i class="fa-pencil"></i> <?php echo __('Редактировать'); ?></a>
                                            </li>
                                            <li class="divider"></li>
                                            <li>
                                                <a title="<?php echo __('Удалить'); ?>" onclick="return confirm('<?php echo __('Это действие необратимо. Продолжить?'); ?>');" href="<?php echo '/wezom/seo_redirects/delete/'.$obj->id; ?>"><i class="fa-trash-o text-danger"></i> <?php echo __('Удалить'); ?></a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
