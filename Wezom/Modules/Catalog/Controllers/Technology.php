...
use Core\Support;
use Core\Arr;
use Wezom\Modules\Catalog\Models\Technology AS Model;

class Technology extends \Wezom\Modules\Base
{

    public $tpl_folder = 'Catalog/Technology';

    function before()
    {
        parent::before();
        $this->_seo['h1'] = __('Технология метода');
        $this->_seo['title'] = __('Технология метода');
        $this->setBreadcrumbs(__('Технология метода'), 'wezom/' . Route::controller() . '/index');
    }
