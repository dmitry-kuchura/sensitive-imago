...
use Core\Support;
use Core\Arr;
use Wezom\Modules\Catalog\Models\Software AS Model;

class Software extends \Wezom\Modules\Base
{

    public $tpl_folder = 'Catalog/Software';

    function before()
    {
        parent::before();
        $this->_seo['h1'] = __('Программное обеспечение');
        $this->_seo['title'] = __('Программное обеспечение');
        $this->setBreadcrumbs(__('Программное обеспечение'), 'wezom/' . Route::controller() . '/index');
    }
