...
use Core\Support;
use Core\Arr;
use Wezom\Modules\Catalog\Models\Mechanism AS Model;

class Mechanism extends \Wezom\Modules\Base
{

    public $tpl_folder = 'Catalog/Mechanism';

    function before()
    {
        parent::before();
        $this->_seo['h1'] = __('Механизм получения информации');
        $this->_seo['title'] = __('Механизм получения информации');
        $this->setBreadcrumbs(__('Механизм получения информации'), 'wezom/' . Route::controller() . '/index');
    }
