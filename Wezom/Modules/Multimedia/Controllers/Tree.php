...
use Wezom\Modules\Multimedia\Models\Tree AS Model;

class Tree extends \Wezom\Modules\Base
{

    public $tpl_folder = 'Multimedia/Tree';

    function before()
    {
        parent::before();
        $this->_seo['h1'] = __('Группы видео');
        $this->_seo['title'] = __('Группы видео');
        $this->setBreadcrumbs(__('Группы видео'), 'wezom/' . Route::controller() . '/index');
    }
