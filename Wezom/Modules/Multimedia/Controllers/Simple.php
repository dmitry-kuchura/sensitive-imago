<?php
    ...
    use Wezom\Modules\Multimedia\Models\Simple AS Model;

    class Simple extends \Wezom\Modules\Base {

        public $tpl_folder = 'Multimedia/Simple';
        public $page;
        public $limit;
        public $offset;
        ...
        function before() {
            parent::before();
            $this->_seo['h1'] = __('Маленький слайдер');
            $this->_seo['title'] = __('Маленький слайдер');
            $this->setBreadcrumbs(__('Маленький слайдер'), 'wezom/'.Route::controller().'/index');
