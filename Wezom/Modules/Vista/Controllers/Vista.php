...
namespace Wezom\Modules\Vista\Controllers;
...
use Core\HTTP;
use Core\View;
use Wezom\Modules\Vista\Models\Vista AS Model;

class Vista extends \Wezom\Modules\Base {

    public $tpl_folder = 'Vista';

    function before() {
        parent::before();
        $this->_seo['h1'] = __('Возможности оборудовния');
        $this->_seo['title'] = __('Возможности оборудовния');
        $this->setBreadcrumbs(__('Возможности оборудовния'), 'wezom/' . Route::controller() . '/index');
    }
