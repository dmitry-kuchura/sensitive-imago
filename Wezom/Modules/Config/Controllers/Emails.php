<?php
    ...
    use Wezom\Modules\Config\Models\Emails AS Model;

    class Emails extends \Wezom\Modules\Base {

        public $tpl_folder = 'Config/Emails';

        function before() {
            parent::before();
            $this->_seo['h1'] = __('E-mail сайта');
            $this->_seo['title'] = __('E-mail сайта');
            $this->setBreadcrumbs(__('E-mail сайта'), 'wezom/'.Route::controller().'/index');
        }
