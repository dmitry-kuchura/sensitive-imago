            ...
            if (typeof validator === 'undefined') {
                formValid.validate({
                    ...
                    submitHandler: function(form) {
                        ...
                        $.magnificPopup.close();
                        var preloader = false;
                        var submitCallback = formJQ.data('cb') || {};
                        ...
                        if (form.tagName.toLowerCase() === 'form') {
                            ...
                            if( formJQ.data('ajax') ) {
                                ...
                                request.onreadystatechange = function() {
                                    ...
                                    if (request.readyState == 4) {
                                        ...
                                        if (status == 200) {
                                            ...
                                            onSubmitCallback(submitCallback.success);
                                            if( resp.redirect ) {
                                        	...
                                        	onSubmitCallback(submitCallback.error);
                                ...
                                // в случае успешной отправки вызвать ▼
                                // onSubmitCallback(submitCallback.success);

                                // в случае ошибке вызвать ▼
                                // onSubmitCallback(submitCallback.error);
