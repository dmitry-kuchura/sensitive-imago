<?php
    ...
    class SimpleImage {
        ...
        static function factory($filename = null, $width = null, $height = null, $color = null) {
            return new self($filename, $width, $height, $color);
        }
         ...
         * @return $this
         */
        function thumb($crop_width, $crop_height, $x, $y) {
            // Perform crop
            $new = imagecreatetruecolor($crop_width, $crop_height);
            imagealphablending($new, false);
            imagesavealpha($new, true);
            imagecopyresampled($new, $this->image, 0, 0, $x, $y, $crop_width, $crop_height, $crop_width, $crop_height);
